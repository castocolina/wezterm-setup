-- Vendored: tinytoml (pure-Lua TOML 1.1.0 decoder)
-- Upstream: https://github.com/FourierTransformer/tinytoml  tag 1.0.0 (commit 663e319179c7800b414afbe58fe29bbe5cba3dec)
-- Source URL: https://raw.githubusercontent.com/FourierTransformer/tinytoml/1.0.0/tinytoml.lua
-- SHA-256 (fetched file, pre-header): 0a0ad7edaac6b95f4da4c3312a24465390367dfeb68c57776fd70334b0f97858
-- License: MIT (Shakil Thakur). Vendored per .planning/decisions/cli-language.md
-- (pure-Lua single file, zero transitive module loads, no luarocks / no C compiler / no network at install).
-- Diff against upstream to audit. Declares _LICENSE="MIT", _VERSION="tinytoml 1.0.0", returns tinytoml.
-- NOTE: upstream tags WITHOUT a leading "v" (tag is "1.0.0", not "v1.0.0"); the v1.0.0 URL 404s.
